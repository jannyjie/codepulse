...
<div class="pagecont border-top pt-3">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="info.php">隱私權政策</a></li>
        </ol>
    </div>
    <section>
        <div class="container">
            <h1 class="mb-4 mb-lg-5">隱私權政策</h1>
            <div class="edit-area">
                <p>非常歡迎您光臨「○○網站」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
