...
<div class="pagecont border-top pt-3 bg-light">
	<div class="container">
		<ol class="breadcrumb">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="box-article"><span class="date">2019-05-02</span>
					<h1>文章標題</h1>
					...
					<div class="edit-area mt-4 mb-4">
						<p> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magnam ad, inventore id nemo enim quam quos ratione. Quidem non adipisci earum, molestiae nulla totam provident, perferendis ea perspiciatis illum sapiente?
						</p>
						<p>文章內文</p>
						<p>文章內文</p>
						<p>文章內文</p>
						...
						<table style="border: 1px solid #000;">
							...
							<tbody>
								<tr>
									<th><br></th>
									<th style="padding: 5px 20px;">Students
									</th>
									<th style="padding: 5px 20px;">Faculty
									</th>
									<th style="padding: 5px 20px;">Babies
									</th>
									<th style="padding: 5px 20px;">Cats
									</th>
									<th style="padding: 5px 20px;">Students
									</th>
									<th style="padding: 5px 20px;">Faculty
